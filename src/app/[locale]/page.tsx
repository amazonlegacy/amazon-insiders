  ...
  return (
    <div className="font-sans text-gray-900">
      ...
      <section className="py-8 px-6 bg-white border-y border-gray-200">
        <div className="flex flex-col sm:grid sm:grid-cols-3 gap-3 sm:gap-6 max-w-3xl mx-auto">
          {[
            ...
            <div key={stat.label} className={`text-center ${i < 2 ? "sm:border-r sm:border-gray-200 py-3 sm:py-0 border-b sm:border-b-0 border-gray-100" : "py-3 sm:py-0"}`}>
              <div className="text-6xl md:text-7xl font-black tracking-tight" style={{ color: "#FF6B35" }}>
                {stat.value}
              </div>
              <div className="text-lg md:text-xl text-gray-600 mt-2 font-semibold">{stat.label}</div>
            </div>
          ))}
        </div>
      </section>
      ...
      <footer className="py-10 px-6" style={{ backgroundColor: "#1a1a2e" }}>
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="text-5xl font-bold tracking-tight" style={{ lineHeight: 1 }}>
